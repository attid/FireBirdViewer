...
from src.domain.models import Column, PagedData, ProcedureInfo
...
def procedure_view(proc: "ProcedureInfo"):
    """Display procedure source code and parameters."""
...
def insert_form(columns: list[Column], table_name: str):
